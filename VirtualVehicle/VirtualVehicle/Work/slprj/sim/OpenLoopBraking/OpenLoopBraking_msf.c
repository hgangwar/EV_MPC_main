...
real_T rtP__CtrlBcuTrlrBrkGain2f2VirtualVehicleTemplate_sldd_ ; const char *
...
& ( rtP__CtrlBcuTrlrBrkGain2f2VirtualVehicleTemplate_sldd_ ) , GlobalPrm_0 ,
sizeof ( real_T ) ) ; } }
#endif
static void mdlInitializeConditions ( SimStruct * S ) { j2diisom34j * dw = (
j2diisom34j * ) ssGetDWork ( S , 0 ) ; boolean_T * o_o_B_1_3 = ( boolean_T *
) ssGetOutputPortSignal ( S , 2 ) ; n5x0ejbjln ( o_o_B_1_3 , & ( dw -> rtb )
...
* ) ssGetOutputPortSignal ( S , 1 ) ; if ( tid == 0 ) { OpenLoopBraking (
i_cpcspq2gwo , o_B_1_1 , o_B_1_2 ) ; } } static void mdlInitializeSizes (
...
1 , 3 ) ; if ( ! ssSetNumInputPorts ( S , 1 ) ) return ; if ( !
...
ssGetDWork ( S , 0 ) ; mdlProcessParameters ( S ) ; hc3tptuv0o ( & ( dw ->
rtb ) ) ; } static void mdlOutputs ( SimStruct * S , int_T tid ) {
j2diisom34j * dw = ( j2diisom34j * ) ssGetDWork ( S , 0 ) ; real_T const *
i_cpcspq2gwo = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T * o_B_1_1
= ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_1_2 = ( real_T
* ) ssGetOutputPortSignal ( S , 1 ) ; boolean_T * o_o_B_1_3 = ( boolean_T * )
ssGetOutputPortSignal ( S , 2 ) ; if ( tid == PARAMETER_TUNING_TID ) {
OpenLoopBrakingTID1 ( o_o_B_1_3 , & ( dw -> rtb ) ) ; } if ( tid !=
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { OpenLoopBraking (
i_cpcspq2gwo , o_B_1_1 , o_B_1_2 ) ; } } static void mdlTerminate ( SimStruct
* S ) { j2diisom34j * dw = ( j2diisom34j * ) ssGetDWork ( S , 0 ) ;
ese1g5rr1h ( & ( dw -> rtm ) ) ; return ; }
