...
static RegMdlInfo rtMdlInfo_OpenLoopBraking [ 39 ] = { { "j2diisom34j" ,
...
MDL_INFO_ID_GLOBAL_RTW_CONSTRUCT , 0 , - 1 , ( void * ) "OpenLoopBraking" } ,
{ "baz2tyrx4j" , MDL_INFO_ID_GLOBAL_RTW_CONSTRUCT , 0 , - 1 , ( void * )
"OpenLoopBraking" } , { "dshwzf1s03" , MDL_INFO_ID_GLOBAL_RTW_CONSTRUCT , 0 ,
...
false } ; void n5x0ejbjln ( boolean_T fh0nkfle4t [ 4 ] , cq4hrfe0rj * localB
) { fh0nkfle4t [ 0 ] = localB -> h2waecyxb4 ; fh0nkfle4t [ 1 ] = localB ->
h2waecyxb4 ; fh0nkfle4t [ 2 ] = localB -> h2waecyxb4 ; fh0nkfle4t [ 3 ] =
localB -> h2waecyxb4 ; } void hc3tptuv0o ( cq4hrfe0rj * localB ) { localB ->
h2waecyxb4 = pqlkmereof . P_2 ; } void OpenLoopBraking ( const real_T *
pkgibffjyg , real_T ch24exy52s [ 4 ] , real_T lsyrlfgmud [ 6 ] ) { real_T
bsxse14na5 ; ch24exy52s [ 0 ] = * pkgibffjyg ; ch24exy52s [ 1 ] = *
pkgibffjyg ; ch24exy52s [ 2 ] = * pkgibffjyg ; ch24exy52s [ 3 ] = *
pkgibffjyg ; bsxse14na5 = ( ( ( ch24exy52s [ 0 ] + ch24exy52s [ 1 ] ) +
ch24exy52s [ 2 ] ) + ch24exy52s [ 3 ] ) * pqlkmereof . P_1 *
rtP__CtrlBcuTrlrBrkGain2f2VirtualVehicleTemplate_sldd_ ; lsyrlfgmud [ 0 ] =
bsxse14na5 ; lsyrlfgmud [ 1 ] = bsxse14na5 ; lsyrlfgmud [ 2 ] = bsxse14na5 ;
lsyrlfgmud [ 3 ] = bsxse14na5 ; lsyrlfgmud [ 4 ] = bsxse14na5 ; lsyrlfgmud [
5 ] = bsxse14na5 ; } void OpenLoopBrakingTID1 ( boolean_T fh0nkfle4t [ 4 ] ,
cq4hrfe0rj * localB ) { localB -> h2waecyxb4 = pqlkmereof . P_2 ; fh0nkfle4t
[ 0 ] = localB -> h2waecyxb4 ; fh0nkfle4t [ 1 ] = localB -> h2waecyxb4 ;
fh0nkfle4t [ 2 ] = localB -> h2waecyxb4 ; fh0nkfle4t [ 3 ] = localB ->
h2waecyxb4 ; } void ese1g5rr1h ( dshwzf1s03 * const njmlsg0bqs ) { if ( !
slIsRapidAcceleratorSimulating ( ) ) { slmrRunPluginEvent ( njmlsg0bqs ->
...
mdlRefSfcnS , modelName , rtMdlInfo_OpenLoopBraking , 39 ) ; * retVal = 1 ; }
...
j2diisom34j * mdlrefDW ) { static const char_T * ssDWFieldNames [ 3 ] = {
"rtb" , "NULL->rtdw" , "NULL->rtzce" , } ; mxArray * ssDW =
mxCreateStructMatrix ( 1 , 1 , 3 , ssDWFieldNames ) ;
mr_OpenLoopBraking_cacheDataAsMxArray ( ssDW , 0 , 0 , ( const void * ) & (
mdlrefDW -> rtb ) , sizeof ( mdlrefDW -> rtb ) ) ; ( void ) mdlrefDW ; return
ssDW ; } void mr_OpenLoopBraking_SetDWork ( j2diisom34j * mdlrefDW , const
mxArray * ssDW ) { ( void ) ssDW ; ( void ) mdlrefDW ;
mr_OpenLoopBraking_restoreDataFromMxArray ( ( void * ) & ( mdlrefDW -> rtb )
, ssDW , 0 , 0 , sizeof ( mdlrefDW -> rtb ) ) ; } void
mr_OpenLoopBraking_RegisterSimStateChecksum ( SimStruct * S ) { const
uint32_T chksum [ 4 ] = { 1245911252U , 1439652994U , 2831645265U ,
2814696065U , } ; slmrModelRefRegisterSimStateChecksum ( S ,
