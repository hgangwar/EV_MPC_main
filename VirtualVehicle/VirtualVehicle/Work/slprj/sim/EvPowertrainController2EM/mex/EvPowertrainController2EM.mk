...
MAKECMD         = /usr/local/MATLAB/R2023b/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = EvPowertrainController2EM
MODULES                 = EvPowertrainController2EM_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/EvPowertrainController2EM_msf.mexa64
MAKEFILE                = EvPowertrainController2EM.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2023b
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2023b
START_DIR               = /home/harsh/Documents/EV_Energy_Optimisation/VirtualVehicle/VirtualVehicle/Work
...
SYSTEM_LIBS             = -L"/usr/local/MATLAB/R2023b/bin/glnxa64" -lmwipp -lfixedpoint -lmwmathutil -lmwsl_AsyncioQueue -lmwsf_runtime -lmwslexec_simlog -lmwcoder_ToAsyncQueueTgtAppSvc -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwstringutil -lemlrt -lmx -lmex
...
MODELLIB                  = EvPowertrainController2EM_msf.mexa64
MODELREF_LINK_LIBS        = ../../../../slprj/sim/EvPowertrainController2EM/EvPowertrainController2EMlib.a
...
MODELREF_LINK_LIBS_GROUP = ../../../../slprj/sim/EvPowertrainController2EM/EvPowertrainController2EMlib.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../../../slprj/sim/EvPowertrainController2EM/EvPowertrainController2EMlib.a -Wl,--end-group
endif
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/EvPowertrainController2EM \
...
EvPowertrainController2EM_msf.o : $(START_DIR)/slprj/sim/EvPowertrainController2EM/EvPowertrainController2EM_msf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/sim/EvPowertrainController2EM/EvPowertrainController2EM_msf.c
