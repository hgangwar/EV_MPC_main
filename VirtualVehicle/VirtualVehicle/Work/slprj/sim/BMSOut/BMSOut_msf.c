...
const * i_ln0ed2trml = ( real32_T * ) ssGetInputPortSignal ( S , 0 ) ;
real32_T const * i_jr3vywyof3 = ( real32_T * ) ssGetInputPortSignal ( S , 1 )
; real32_T const * i_myhpznh1qe = ( real32_T * ) ssGetInputPortSignal ( S , 2
) ; boolean_T const * i_eydjp3acxu = ( boolean_T * ) ssGetInputPortSignal ( S
, 3 ) ; boolean_T const * i_epj4uyosod = ( boolean_T * ) ssGetInputPortSignal
( S , 4 ) ; boolean_T const * i_dqzeto3ng1 = ( boolean_T * )
ssGetInputPortSignal ( S , 5 ) ; boolean_T const * i_lvuahtp014 = ( boolean_T
* ) ssGetInputPortSignal ( S , 6 ) ; boolean_T const * i_kxyqzvuf01 = (
boolean_T * ) ssGetInputPortSignal ( S , 7 ) ; boolean_T const * i_keczemqmmd
= ( boolean_T * ) ssGetInputPortSignal ( S , 8 ) ; boolean_T const *
i_op02sompag = ( boolean_T * ) ssGetInputPortSignal ( S , 9 ) ; real32_T
const * i_i50tjsducg = ( real32_T * ) ssGetInputPortSignal ( S , 10 ) ;
real32_T const * i_n3vpraxo4r = ( real32_T * ) ssGetInputPortSignal ( S , 11
) ; real32_T const * i_o5gcv3qbp3 = ( real32_T * ) ssGetInputPortSignal ( S ,
12 ) ; real32_T const * i_de1twf1tkf = ( real32_T * ) ssGetInputPortSignal (
S , 13 ) ; boolean_T const * i_gsvq5blzyq = ( boolean_T * )
ssGetInputPortSignal ( S , 14 ) ; real32_T * o_B_1_1 = ( real32_T * )
ssGetOutputPortSignal ( S , 0 ) ; real32_T * o_B_1_2 = ( real32_T * )
ssGetOutputPortSignal ( S , 1 ) ; real32_T * o_B_1_3 = ( real32_T * )
...
ssGetOutputPortSignal ( S , 5 ) ; boolean_T * o_B_1_7 = ( boolean_T * )
ssGetOutputPortSignal ( S , 6 ) ; boolean_T * o_B_1_8 = ( boolean_T * )
ssGetOutputPortSignal ( S , 7 ) ; boolean_T * o_B_1_9 = ( boolean_T * )
ssGetOutputPortSignal ( S , 8 ) ; boolean_T * o_B_1_10 = ( boolean_T * )
ssGetOutputPortSignal ( S , 9 ) ; boolean_T * o_B_1_11 = ( boolean_T * )
ssGetOutputPortSignal ( S , 10 ) ; real32_T * o_B_1_12 = ( real32_T * )
ssGetOutputPortSignal ( S , 11 ) ; real32_T * o_B_1_13 = ( real32_T * )
ssGetOutputPortSignal ( S , 12 ) ; real32_T * o_B_1_14 = ( real32_T * )
ssGetOutputPortSignal ( S , 13 ) ; real32_T * o_B_1_15 = ( real32_T * )
ssGetOutputPortSignal ( S , 14 ) ; if ( tid == 0 ) { BMSOutTID0 (
i_ln0ed2trml , i_jr3vywyof3 , i_myhpznh1qe , i_eydjp3acxu , i_epj4uyosod ,
i_dqzeto3ng1 , i_lvuahtp014 , i_kxyqzvuf01 , i_keczemqmmd , i_op02sompag ,
i_i50tjsducg , i_n3vpraxo4r , i_o5gcv3qbp3 , i_de1twf1tkf , i_gsvq5blzyq ,
o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 , o_B_1_7 , o_B_1_8
, o_B_1_9 , o_B_1_10 , o_B_1_11 , o_B_1_12 , o_B_1_13 , o_B_1_14 , o_B_1_15 )
; } if ( tid == 1 ) { BMSOutTID1 ( ) ; } } static void mdlInitializeSizes (
...
15 , 15 ) ; if ( ! ssSetNumInputPorts ( S , 15 ) ) return ; if ( !
...
false ) ; ssSetInputPortSampleTime ( S , 13 , 0.1 ) ;
ssSetInputPortOffsetTime ( S , 13 , 0.0 ) ; if ( !
ssSetInputPortMatrixDimensions ( S , 14 , 1 , 96 ) ) return ;
ssSetInputPortDimensionsMode ( S , 14 , FIXED_DIMS_MODE ) ;
ssSetInputPortFrameData ( S , 14 , FRAME_NO ) ; if ( ssGetSimMode ( S ) !=
SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetInputPortDataType ( S , 14 , SS_BOOLEAN )
; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "" , & unitIdReg ) ; if (
...
false ) ; ssSetInputPortSampleTime ( S , 14 , 5.0 ) ;
...
SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetOutputPortDataType ( S , 13 , SS_SINGLE )
; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "" , & unitIdReg ) ; if (
...
SS_SIMMODE_SIZES_CALL_ONLY ) { ssSetOutputPortDataType ( S , 14 , SS_SINGLE )
; } if ( ssGetSimMode ( S ) != SS_SIMMODE_SIZES_CALL_ONLY ) {
#if defined (MATLAB_MEX_FILE)
UnitId unitIdReg ; ssRegisterUnitFromExpr ( S , "" , & unitIdReg ) ; if (
...
= 0 ; } gzneizzges ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) ,
slmrGetTopTidFromMdlRefChildTid ( S , 1 , false ) , sysRanPtr , sysTid , ( (
NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ; ssSetModelMappingInfoPtr ( S , & (
pcu03dvoe3 . rtm . DataMapInfo . mmi ) ) ; if ( S -> mdlInfo -> genericFcn !=
( NULL ) ) { _GenericFcn fcn = S -> mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { } static void mdlOutputs ( SimStruct
* S , int_T tid ) { real32_T const * i_ln0ed2trml = ( real32_T * )
ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_jr3vywyof3 = ( real32_T *
) ssGetInputPortSignal ( S , 1 ) ; real32_T const * i_myhpznh1qe = ( real32_T
* ) ssGetInputPortSignal ( S , 2 ) ; boolean_T const * i_eydjp3acxu = (
boolean_T * ) ssGetInputPortSignal ( S , 3 ) ; boolean_T const * i_epj4uyosod
= ( boolean_T * ) ssGetInputPortSignal ( S , 4 ) ; boolean_T const *
i_dqzeto3ng1 = ( boolean_T * ) ssGetInputPortSignal ( S , 5 ) ; boolean_T
const * i_lvuahtp014 = ( boolean_T * ) ssGetInputPortSignal ( S , 6 ) ;
boolean_T const * i_kxyqzvuf01 = ( boolean_T * ) ssGetInputPortSignal ( S , 7
) ; boolean_T const * i_keczemqmmd = ( boolean_T * ) ssGetInputPortSignal ( S
, 8 ) ; boolean_T const * i_op02sompag = ( boolean_T * ) ssGetInputPortSignal
( S , 9 ) ; real32_T const * i_i50tjsducg = ( real32_T * )
ssGetInputPortSignal ( S , 10 ) ; real32_T const * i_n3vpraxo4r = ( real32_T
* ) ssGetInputPortSignal ( S , 11 ) ; real32_T const * i_o5gcv3qbp3 = (
real32_T * ) ssGetInputPortSignal ( S , 12 ) ; real32_T const * i_de1twf1tkf
= ( real32_T * ) ssGetInputPortSignal ( S , 13 ) ; boolean_T const *
i_gsvq5blzyq = ( boolean_T * ) ssGetInputPortSignal ( S , 14 ) ; real32_T *
o_B_1_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ; real32_T * o_B_1_2
= ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ; real32_T * o_B_1_3 = (
real32_T * ) ssGetOutputPortSignal ( S , 2 ) ; boolean_T * o_B_1_4 = (
...
boolean_T * ) ssGetOutputPortSignal ( S , 7 ) ; boolean_T * o_B_1_9 = (
boolean_T * ) ssGetOutputPortSignal ( S , 8 ) ; boolean_T * o_B_1_10 = (
boolean_T * ) ssGetOutputPortSignal ( S , 9 ) ; boolean_T * o_B_1_11 = (
boolean_T * ) ssGetOutputPortSignal ( S , 10 ) ; real32_T * o_B_1_12 = (
real32_T * ) ssGetOutputPortSignal ( S , 11 ) ; real32_T * o_B_1_13 = (
real32_T * ) ssGetOutputPortSignal ( S , 12 ) ; real32_T * o_B_1_14 = (
real32_T * ) ssGetOutputPortSignal ( S , 13 ) ; real32_T * o_B_1_15 = (
real32_T * ) ssGetOutputPortSignal ( S , 14 ) ; if ( tid != CONSTANT_TID &&
tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 , tid ) ) {
BMSOutTID0 ( i_ln0ed2trml , i_jr3vywyof3 , i_myhpznh1qe , i_eydjp3acxu ,
i_epj4uyosod , i_dqzeto3ng1 , i_lvuahtp014 , i_kxyqzvuf01 , i_keczemqmmd ,
i_op02sompag , i_i50tjsducg , i_n3vpraxo4r , i_o5gcv3qbp3 , i_de1twf1tkf ,
i_gsvq5blzyq , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 ,
o_B_1_7 , o_B_1_8 , o_B_1_9 , o_B_1_10 , o_B_1_11 , o_B_1_12 , o_B_1_13 ,
o_B_1_14 , o_B_1_15 ) ; } if ( ssIsSampleHit ( S , 1 , tid ) ) { BMSOutTID1 (
) ; } } } static void mdlTerminate ( SimStruct * S ) { jhgahwtvq0 ( ) ;
return ; }
...
mr_BMSOut_GetDWork ( ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW ) ; } {
mxArray * data = mr_BMSOut_GetSimStateDisallowedBlocks ( ) ;
...
( localX , & rawData [ 0 ] , numBytes ) ; } mr_BMSOut_SetDWork (
