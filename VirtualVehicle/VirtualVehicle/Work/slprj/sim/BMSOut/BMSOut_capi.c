...
{ 4036326378U , 72227033U , 3503367477U , 2992559649U } , &
...
int rootTid ) { UNUSED_PARAMETER ( dwsl3wlhtm ) ; systemRan [ 0 ] = (
sysRanDType * ) rootSysRanPtr ; systemRan [ 1 ] = ( NULL ) ; systemTid [ 1 ]
= hhvz4om4xd [ 0 ] ; systemTid [ 0 ] = rootTid ; rtContextSystems [ 0 ] = 0 ;
...
dwsl3wlhtm -> DataMapInfo . mmiLogInstanceInfo ) ; rtwCAPI_SetChildMMIArray (
dwsl3wlhtm -> DataMapInfo . mmi , ( NULL ) ) ; rtwCAPI_SetChildMMIArrayLen (
dwsl3wlhtm -> DataMapInfo . mmi , 0 ) ; BMSOut_InitializeSystemRan (
dwsl3wlhtm , dwsl3wlhtm -> DataMapInfo . systemRan , dwsl3wlhtm ->
...
rtwCAPI_SetSystemTid ( dwsl3wlhtm -> DataMapInfo . mmi , dwsl3wlhtm ->
DataMapInfo . systemTid ) ; rtwCAPI_SetGlobalTIDMap ( dwsl3wlhtm ->
DataMapInfo . mmi , & hhvz4om4xd [ 0 ] ) ; }
#else
#ifdef __cplusplus
extern "C" {
#endif
