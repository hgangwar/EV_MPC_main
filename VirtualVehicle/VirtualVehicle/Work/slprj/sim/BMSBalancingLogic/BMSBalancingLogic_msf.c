...
o_o_o_B_2_1 = ( boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ; okbayvkvs0 (
o_o_o_B_2_1 ) ; } static void mdlReset ( SimStruct * S ) { boolean_T *
o_o_o_B_2_1 = ( boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ; l0kmnlkf5y (
o_o_o_B_2_1 ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T
tid ) { real32_T const * i_cebvpcbp1q = ( real32_T * ) ssGetInputPortSignal (
S , 0 ) ; real32_T const * i_dp3icoqurv = ( real32_T * ) ssGetInputPortSignal
( S , 1 ) ; real32_T const * i_owyaaxflzk = ( real32_T * )
ssGetInputPortSignal ( S , 2 ) ; real32_T const * i_bfjeehnrqx = ( real32_T *
) ssGetInputPortSignal ( S , 3 ) ; boolean_T * o_o_o_B_2_1 = ( boolean_T * )
ssGetOutputPortSignal ( S , 0 ) ; if ( tid == 0 ) { BMSBalancingLogic (
i_cebvpcbp1q , i_dp3icoqurv , i_owyaaxflzk , i_bfjeehnrqx , o_o_o_B_2_1 ) ; }
...
= 0 ; } bjd0wkxsam ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) ,
sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ;
ssSetModelMappingInfoPtr ( S , & ( nxoas2gjfb . rtm . DataMapInfo . mmi ) ) ;
if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S ->
mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { } static void mdlOutputs ( SimStruct
* S , int_T tid ) { real32_T const * i_cebvpcbp1q = ( real32_T * )
ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_dp3icoqurv = ( real32_T *
) ssGetInputPortSignal ( S , 1 ) ; real32_T const * i_owyaaxflzk = ( real32_T
* ) ssGetInputPortSignal ( S , 2 ) ; real32_T const * i_bfjeehnrqx = (
real32_T * ) ssGetInputPortSignal ( S , 3 ) ; boolean_T * o_o_o_B_2_1 = (
boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid != CONSTANT_TID &&
tid != PARAMETER_TUNING_TID ) { BMSBalancingLogic ( i_cebvpcbp1q ,
i_dp3icoqurv , i_owyaaxflzk , i_bfjeehnrqx , o_o_o_B_2_1 ) ; } } static void
mdlTerminate ( SimStruct * S ) { jozn1uvmvd ( ) ; return ; }
...
mr_BMSBalancingLogic_GetDWork ( ) ; mxSetFieldByNumber ( ss , 0 , 1 ,
mdlrefDW ) ; } { mxArray * data =
mr_BMSBalancingLogic_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber (
...
( localX , & rawData [ 0 ] , numBytes ) ; } mr_BMSBalancingLogic_SetDWork (
