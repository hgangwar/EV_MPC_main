...
o_o_o_B_2_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ; boolean_T *
o_o_o_B_2_2 = ( boolean_T * ) ssGetOutputPortSignal ( S , 1 ) ; boolean_T *
o_o_o_B_2_3 = ( boolean_T * ) ssGetOutputPortSignal ( S , 2 ) ; boolean_T *
o_o_o_B_2_4 = ( boolean_T * ) ssGetOutputPortSignal ( S , 3 ) ; boolean_T *
o_o_o_B_2_5 = ( boolean_T * ) ssGetOutputPortSignal ( S , 4 ) ; boolean_T *
o_o_o_B_2_6 = ( boolean_T * ) ssGetOutputPortSignal ( S , 5 ) ; boolean_T *
o_o_o_B_2_7 = ( boolean_T * ) ssGetOutputPortSignal ( S , 6 ) ; boolean_T *
o_o_o_B_2_8 = ( boolean_T * ) ssGetOutputPortSignal ( S , 7 ) ; real32_T *
o_o_o_B_2_9 = ( real32_T * ) ssGetOutputPortSignal ( S , 8 ) ; c4qsdumjq2 (
o_o_o_B_2_1 , o_o_o_B_2_2 , o_o_o_B_2_3 , o_o_o_B_2_4 , o_o_o_B_2_5 ,
o_o_o_B_2_6 , o_o_o_B_2_7 , o_o_o_B_2_8 , o_o_o_B_2_9 ) ; } static void
mdlReset ( SimStruct * S ) { real32_T * o_o_o_B_2_1 = ( real32_T * )
ssGetOutputPortSignal ( S , 0 ) ; boolean_T * o_o_o_B_2_2 = ( boolean_T * )
ssGetOutputPortSignal ( S , 1 ) ; boolean_T * o_o_o_B_2_3 = ( boolean_T * )
ssGetOutputPortSignal ( S , 2 ) ; boolean_T * o_o_o_B_2_4 = ( boolean_T * )
ssGetOutputPortSignal ( S , 3 ) ; boolean_T * o_o_o_B_2_5 = ( boolean_T * )
ssGetOutputPortSignal ( S , 4 ) ; boolean_T * o_o_o_B_2_6 = ( boolean_T * )
ssGetOutputPortSignal ( S , 5 ) ; boolean_T * o_o_o_B_2_7 = ( boolean_T * )
ssGetOutputPortSignal ( S , 6 ) ; boolean_T * o_o_o_B_2_8 = ( boolean_T * )
ssGetOutputPortSignal ( S , 7 ) ; real32_T * o_o_o_B_2_9 = ( real32_T * )
ssGetOutputPortSignal ( S , 8 ) ; b24n3fhfdi ( o_o_o_B_2_1 , o_o_o_B_2_2 ,
o_o_o_B_2_3 , o_o_o_B_2_4 , o_o_o_B_2_5 , o_o_o_B_2_6 , o_o_o_B_2_7 ,
o_o_o_B_2_8 , o_o_o_B_2_9 ) ; } static void mdlPeriodicOutputUpdate (
SimStruct * S , int_T tid ) { real32_T const * i_aet3mh4vnx = ( real32_T * )
ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_ius14z4yqa = ( real32_T *
) ssGetInputPortSignal ( S , 1 ) ; real32_T const * i_g4w4o03p5c = ( real32_T
* ) ssGetInputPortSignal ( S , 2 ) ; real32_T const * i_oq53j5fbgk = (
real32_T * ) ssGetInputPortSignal ( S , 3 ) ; real32_T const * i_dk3i3pmwqy =
( real32_T * ) ssGetInputPortSignal ( S , 4 ) ; real32_T const * i_fxld3up0sn
= ( real32_T * ) ssGetInputPortSignal ( S , 5 ) ; real32_T const *
i_iyza5xk5kg = ( real32_T * ) ssGetInputPortSignal ( S , 6 ) ; real32_T const
* i_mqxfvks2ha = ( real32_T * ) ssGetInputPortSignal ( S , 7 ) ; real32_T
const * i_lfvaqshwsr = ( real32_T * ) ssGetInputPortSignal ( S , 8 ) ;
real32_T const * i_eouoyhofxw = ( real32_T * ) ssGetInputPortSignal ( S , 9 )
; real32_T const * i_o21tm4eero = ( real32_T * ) ssGetInputPortSignal ( S ,
...
( tid == 0 ) { BMSStateMachine ( i_aet3mh4vnx , i_ius14z4yqa , i_g4w4o03p5c ,
i_oq53j5fbgk , i_dk3i3pmwqy , i_fxld3up0sn , i_iyza5xk5kg , i_mqxfvks2ha ,
i_lfvaqshwsr , i_eouoyhofxw , i_o21tm4eero , i_mlyz23opxw , o_o_o_B_2_1 ,
o_o_o_B_2_2 , o_o_o_B_2_3 , o_o_o_B_2_4 , o_o_o_B_2_5 , o_o_o_B_2_6 ,
o_o_o_B_2_7 , o_o_o_B_2_8 , o_o_o_B_2_9 ) ; } } static void
...
slmrInitializeIOPortDataVectors ( S , 12 , 9 ) ; if ( ! ssSetNumInputPorts (
...
= 0 ; } n2eo0cythm ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) ,
sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ;
ssSetModelMappingInfoPtr ( S , & ( hmzlgbhyja . rtm . DataMapInfo . mmi ) ) ;
if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S ->
mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { } static void mdlOutputs ( SimStruct
* S , int_T tid ) { real32_T const * i_aet3mh4vnx = ( real32_T * )
ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_ius14z4yqa = ( real32_T *
) ssGetInputPortSignal ( S , 1 ) ; real32_T const * i_g4w4o03p5c = ( real32_T
* ) ssGetInputPortSignal ( S , 2 ) ; real32_T const * i_oq53j5fbgk = (
real32_T * ) ssGetInputPortSignal ( S , 3 ) ; real32_T const * i_dk3i3pmwqy =
...
boolean_T * o_o_o_B_2_8 = ( boolean_T * ) ssGetOutputPortSignal ( S , 7 ) ;
real32_T * o_o_o_B_2_9 = ( real32_T * ) ssGetOutputPortSignal ( S , 8 ) ; if
( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { BMSStateMachine (
i_aet3mh4vnx , i_ius14z4yqa , i_g4w4o03p5c , i_oq53j5fbgk , i_dk3i3pmwqy ,
i_fxld3up0sn , i_iyza5xk5kg , i_mqxfvks2ha , i_lfvaqshwsr , i_eouoyhofxw ,
i_o21tm4eero , i_mlyz23opxw , o_o_o_B_2_1 , o_o_o_B_2_2 , o_o_o_B_2_3 ,
o_o_o_B_2_4 , o_o_o_B_2_5 , o_o_o_B_2_6 , o_o_o_B_2_7 , o_o_o_B_2_8 ,
o_o_o_B_2_9 ) ; } } static void mdlTerminate ( SimStruct * S ) { jqgqne15uw (
) ; return ; }
...
mr_BMSStateMachine_GetDWork ( ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW
) ; } { mxArray * data = mr_BMSStateMachine_GetSimStateDisallowedBlocks ( ) ;
...
( localX , & rawData [ 0 ] , numBytes ) ; } mr_BMSStateMachine_SetDWork (
