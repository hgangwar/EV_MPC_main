...
& ( rtP__PlntBattNumCellPar2f2BatteryDCDC_sldd_ ) , GlobalPrm_0 , sizeof (
real_T ) ) ; } }
#endif
static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T tid ) { real32_T
const * i_b4lme33cv2 = ( real32_T * ) ssGetInputPortSignal ( S , 0 ) ;
real32_T const * i_lkc45qqj2d = ( real32_T * ) ssGetInputPortSignal ( S , 1 )
; real32_T * o_B_1_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ;
real32_T * o_B_1_2 = ( real32_T * ) ssGetOutputPortSignal ( S , 1 ) ;
real32_T * o_B_1_3 = ( real32_T * ) ssGetOutputPortSignal ( S , 2 ) ;
real32_T * o_B_1_4 = ( real32_T * ) ssGetOutputPortSignal ( S , 3 ) ;
real32_T * o_B_1_5 = ( real32_T * ) ssGetOutputPortSignal ( S , 4 ) ;
real32_T * o_B_1_6 = ( real32_T * ) ssGetOutputPortSignal ( S , 5 ) ; if (
tid == 0 ) { BMSCurrPowerLimCalc ( i_b4lme33cv2 , i_lkc45qqj2d , o_B_1_1 ,
o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 ) ; } } static void
...
slmrInitializeIOPortDataVectors ( S , 2 , 6 ) ; if ( ! ssSetNumInputPorts ( S
, 2 ) ) return ; if ( ! ssSetInputPortVectorDimension ( S , 0 , 96 ) ) return
...
mr_BMSCurrPowerLimCalc_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes (
...
= 0 ; } mmipgl5oaa ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) ,
sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ;
ssSetModelMappingInfoPtr ( S , & ( ozx2hltu2v . rtm . DataMapInfo . mmi ) ) ;
...
real32_T * ) ssGetOutputPortSignal ( S , 5 ) ; if ( tid != CONSTANT_TID &&
tid != PARAMETER_TUNING_TID ) { BMSCurrPowerLimCalc ( i_b4lme33cv2 ,
i_lkc45qqj2d , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 ) ;
} } static void mdlTerminate ( SimStruct * S ) { du2aze3q0u ( ) ; return ; }
...
mr_BMSCurrPowerLimCalc_GetDWork ( ) ; mxSetFieldByNumber ( ss , 0 , 1 ,
mdlrefDW ) ; } { mxArray * data =
mr_BMSCurrPowerLimCalc_GetSimStateDisallowedBlocks ( ) ; mxSetFieldByNumber (
...
( localX , & rawData [ 0 ] , numBytes ) ; } mr_BMSCurrPowerLimCalc_SetDWork (
