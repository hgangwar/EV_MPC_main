...
{ 4068992329U , 2882880461U , 958890290U , 3515841359U } , &
...
systemTid [ 1 ] = fiuo2fvsaw [ 0 ] ; systemTid [ 0 ] = rootTid ;
...
jhq13jgrxf -> DataMapInfo . mmi , 1 ) ; rtwCAPI_SetStaticMap ( jhq13jgrxf ->
DataMapInfo . mmi , & mmiStatic ) ; rtwCAPI_SetLoggingStaticMap ( jhq13jgrxf
-> DataMapInfo . mmi , & mmiStaticInfoLogging ) ; rtwCAPI_SetPath (
jhq13jgrxf -> DataMapInfo . mmi , ( NULL ) ) ; rtwCAPI_SetFullPath (
jhq13jgrxf -> DataMapInfo . mmi , ( NULL ) ) ; rtwCAPI_SetInstanceLoggingInfo
( jhq13jgrxf -> DataMapInfo . mmi , & jhq13jgrxf -> DataMapInfo .
mmiLogInstanceInfo ) ; rtwCAPI_SetChildMMIArray ( jhq13jgrxf -> DataMapInfo .
mmi , ( NULL ) ) ; rtwCAPI_SetChildMMIArrayLen ( jhq13jgrxf -> DataMapInfo .
mmi , 0 ) ; BMSCurrPowerLimCalc_InitializeSystemRan ( jhq13jgrxf , jhq13jgrxf
-> DataMapInfo . systemRan , jhq13jgrxf -> DataMapInfo . systemTid ,
sysRanPtr , contextTid ) ; rtwCAPI_SetSystemRan ( jhq13jgrxf -> DataMapInfo .
mmi , jhq13jgrxf -> DataMapInfo . systemRan ) ; rtwCAPI_SetSystemTid (
jhq13jgrxf -> DataMapInfo . mmi , jhq13jgrxf -> DataMapInfo . systemTid ) ;
rtwCAPI_SetGlobalTIDMap ( jhq13jgrxf -> DataMapInfo . mmi , & fiuo2fvsaw [ 0
] ) ; }
#else
#ifdef __cplusplus
extern "C" {
...
BMSCurrPowerLimCalc_host_DataMapInfo_T * dataMap , const char * path ) {
