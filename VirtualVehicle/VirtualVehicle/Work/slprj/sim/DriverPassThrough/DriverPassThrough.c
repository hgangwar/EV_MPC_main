...
mdlRefSfcnS , modelName , rtMdlInfo_DriverPassThrough , 37 ) ; * retVal = 1 ;
...
uint32_T chksum [ 4 ] = { 2793682000U , 3634066754U , 3386686521U ,
2976923305U , } ; slmrModelRefRegisterSimStateChecksum ( S ,
