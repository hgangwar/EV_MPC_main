#ifndef RTW_HEADER_BMSSOCEstimation_private_h_
#define RTW_HEADER_BMSSOCEstimation_private_h_
#include "rtwtypes.h"
...
#define rtmDisableTaskUsingRateIndex(rtm, sti) simTgtDisableTaskUsingRateIndex(_ssGetRootSS((rtm)->_mdlRefSfcnS), gtoacagi4d[sti])
#endif
#ifndef rtmEnableTaskUsingRateIndex
#define rtmEnableTaskUsingRateIndex(rtm, sti) simTgtEnableTaskUsingRateIndex(_ssGetRootSS((rtm)->_mdlRefSfcnS), gtoacagi4d[sti])
#endif
...
#endif
typedef struct { real32_T d4fgipjxpa ; real32_T ar1bzqqdj5 ; real32_T
d1ctigxruw ; real32_T iglwd253k2 ; real32_T egguedpe31 ; } pbiqgdx5zan ;
typedef struct { real32_T myrqiep04m ; } izjsvhfdpsu ; struct aisrboyg3zp_ {
real32_T P_3 ; real32_T P_4 ; real32_T P_5 ; real32_T P_6 ; real32_T P_7 ;
real32_T P_8 ; real32_T P_9 ; } ; struct hpenwvdsgo { struct SimStruct_tag *
...
#define rtmGetClockTick0(rtm) ssGetClockTick( _ssGetRootSS((rtm)->_mdlRefSfcnS), gtoacagi4d[0])
#endif
#ifndef rtmGetClockTickH0
#define rtmGetClockTickH0(rtm) ssGetClockTickH( _ssGetRootSS((rtm)->_mdlRefSfcnS), gtoacagi4d[0])
#endif
#ifndef rtmGetLogOutput
#define rtmGetLogOutput(rtm) ssGetLogOutput((rtm)->_mdlRefSfcnS)
#endif
#ifndef rtmSetSampleHit
#define rtmSetSampleHit(rtm, sti, tid, val) _ssSetSampleHit(_ssGetRootSS((rtm)->_mdlRefSfcnS), gtoacagi4d[sti], val)
#endif
#ifndef rtmIsSampleHit
#define rtmIsSampleHit(rtm, sti, tid) ssIsSampleHit( _ssGetRootSS((rtm)->_mdlRefSfcnS), gtoacagi4d[sti], tid)
#endif
#ifndef rtmGetT
...
#define rtmGetTNextWasAdjusted(rtm, sti) (ssGetTNextWasAdjusted((rtm)->_mdlRefSfcnS,  gtoacagi4d[sti]))
#endif
#ifndef rtmGetTStart
#define rtmGetTStart(rtm) (ssGetTStart((rtm)->_mdlRefSfcnS))
#endif
#ifndef rtmGetTaskTime
#define rtmGetTaskTime(rtm, sti) ssGetTaskTime( _ssGetRootSS((rtm)->_mdlRefSfcnS), gtoacagi4d[sti])
#endif
#ifndef rtmSetTaskTime
#define rtmSetTaskTime(rtm, sti, val) _ssSetTaskTime(_ssGetRootSS((rtm)->_mdlRefSfcnS), gtoacagi4d[sti], val)
#endif
#ifndef rtmGetTimeOfLastOutput
#define rtmGetTimeOfLastOutput(rtm) (ssGetTimeOfLastOutput((rtm)->_mdlRefSfcnS))
#endif
#ifndef rtmGetVarNextHitTime
#define rtmGetVarNextHitTime(rtm, sti) (_ssGetVarNextHitTime((rtm)->_mdlRefSfcnS,  (int)(ssGetOffsetTime(_ssGetRootSS((rtm)->_mdlRefSfcnS), gtoacagi4d[sti+1]))))
#endif
#ifndef rtmSetVarNextHitTime
#define rtmSetVarNextHitTime(rtm, sti, val) ssSetTimeOfNextVarHit((rtm)->_mdlRefSfcnS,  gtoacagi4d[sti], val)
#endif
typedef struct { fcomfl1sgs rtm ; } pe5hyd5e5ea ; extern int_T gtoacagi4d [ 1
] ; extern aisrboyg3zp iwvfcolfgw ; extern pe5hyd5e5ea pe5hyd5e5e ; extern
pbiqgdx5zan lqti3bxlc5b ; extern izjsvhfdpsu elgpnmgrvh5 ;
#endif
